    ...
    <Container>
      <Body>
        ...
        <Description>
          ...
          <p>{event.spotsTaken}/{event.spotsAvailable}</p>
        </Description>
        <ButtonRow>
      ...
      {showRsvpList && (
        <RsvpList eventId={eventId} eventName={event.name!} eventDescription={event.description!} eventExpiry={parseISO(event.expiry!)} />
      )}
    </Container >
  );
}
